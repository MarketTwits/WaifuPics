package com.markettwits.cloud_datasource.presentation.components.bottom_pannel
...
import com.markettwits.cloud_datasource.presentation.components.bottom_pannel.buttons.BasePanelItem
import com.markettwits.cloud_datasource.presentation.components.bottom_pannel.buttons.HeartButton
import com.markettwits.cloud_datasource.presentation.components.bottom_pannel.buttons.RefreshPanelItem
import com.markettwits.cloud_datasource.presentation.components.bottom_pannel.buttons.ReportedButton
...
fun BottomPanel() {
    ...
    Row(
        ...
        BasePanelItem(
            ...
            image = org.jetbrains.compose.resources.painterResource(Res.drawable.ic_bookmark),
            enabled = enabled
        ) {}
        HeartButton(
            modifier = Modifier.weight(1f),
        ...
        BasePanelItem(
            modifier = Modifier.weight(1f),
            image = org.jetbrains.compose.resources.painterResource(Res.drawable.ic_share),
            enabled = enabled
        ) {
